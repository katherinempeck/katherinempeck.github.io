window.onload = function(){
    ...
    // create map 
        ...
        var map = L.map('mapId').setView([20.12940354162719, -155.79870050371983], 12);
    ...
    // Create layer variables
        ...
        var isohyets = L.geoJSON(annIso, {
            onEachFeature: function (feature, layer) {
                layer.setText((String(feature.properties.CONTOUR)), {attributes: {fill: "#42adff"}});
            },
            style: annIsoStyle
        });
    ...
    // Add Print/export Button to map
        ...
        // Seems to be some issue with this plugin where users cannot selectively hide classes - either all map elements are displayed (e.g. zoom and scale) or none
    ...
    $("#runIntersect").click(function () {
        ...
        $("#clearIntersect").click(function () {
            ...
            for (var i = 0; i < buttonList2.length; i++) {
                console.log(buttonList2[i]);
                $(buttonList2[i]).hide();
            }
        });
    });
    
    // Reset map view buttton
    $("#refreshMap").click(function () {
        map.setView([20.12940354162719, -155.79870050371983], 12);
    });
